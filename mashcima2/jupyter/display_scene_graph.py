...
from mashcima2.scene.SceneObject import SceneObject, Link
...
def _scene_object_to_color(scene_object: SceneObject) -> str:
    ...
    if "mashcima2.scene.visual" in typename: return "green"
    if "mashcima2.scene.semantic" in typename: return "#11479e"
    return "gray"
