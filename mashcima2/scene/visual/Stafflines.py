...
class StaffCoordinateSystem(abc.ABC):
    ...
    def get_transform(
        ...
        """Converts stafflines coordinates (pitch posiiton in staffspace units,
        where zero is the middle staffline; time position in milimeters from
        the begining of the staff) to a transform to a specific place (and
        possibly rotation) on the staff."""
